...
def lstm(X):
    ...
    dropoutLstm = tf.nn.rnn_cell.DropoutWrapper(basicLstm, output_keep_prob=keep_prob)
    cell = tf.nn.rnn_cell.MultiRNNCell([dropoutLstm]*lstm_layers)
...
def train_lstm(batch_size=40,time_step=20,train_begin=2000,train_end=4000):
